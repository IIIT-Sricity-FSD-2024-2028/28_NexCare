...
export class CreateUserDto {
  ...
  @ApiPropertyOptional({ example: 'jane@nexcare.com', description: 'Email address (auto-generated if omitted)' })
  @IsOptional()
  @IsString()
  email?: string;
  ...
  @ApiPropertyOptional({ example: true, description: 'Must change password flag' })
  @IsOptional()
