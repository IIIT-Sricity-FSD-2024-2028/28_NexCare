...
export class BedsService {
  ...
  private beds: Bed[] = [
    { id: 'E1', ward: 'Emergency', status: BedStatus.OCCUPIED, patient: 'Ravi Kumar' },
    { id: 'E2', ward: 'Emergency', status: BedStatus.CRITICAL, patient: 'Anita Sharma' },
    { id: 'E3', ward: 'Emergency', status: BedStatus.AVAILABLE, patient: '' },
    { id: 'G1', ward: 'General', status: BedStatus.OCCUPIED, patient: 'John Doe' },
    { id: 'G2', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Priya Singh' },
    { id: 'G3', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Amit Verma' },
    { id: 'G4', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Kiran Rao' },
    { id: 'G5', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Rahul Jain' },
    { id: 'G6', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Deepak Kumar' },
    { id: 'G7', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Arjun Reddy' },
    { id: 'G8', ward: 'General', status: BedStatus.OCCUPIED, patient: 'Neha Gupta' },
    { id: 'G9', ward: 'General', status: BedStatus.AVAILABLE, patient: '' },
    { id: 'G10', ward: 'General', status: BedStatus.AVAILABLE, patient: '' },
    { id: 'P1', ward: 'Pediatrics', status: BedStatus.OCCUPIED, patient: 'Kid A' },
    { id: 'P2', ward: 'Pediatrics', status: BedStatus.AVAILABLE, patient: '' },
    { id: 'P3', ward: 'Pediatrics', status: BedStatus.AVAILABLE, patient: '' },
    { id: 'M1', ward: 'Maternity', status: BedStatus.OCCUPIED, patient: 'Mother A' },
    { id: 'M2', ward: 'Maternity', status: BedStatus.OCCUPIED, patient: 'Mother B' },
