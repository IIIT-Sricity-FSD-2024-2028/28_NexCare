...
let BedsService = BedsService_1 = class BedsService {
    ...
    async allocate(id, patient) {
        try {
            ...
            this.store.save(beds);
            return response_util_1.ResponseUtil.updated('Bed allocated successfully', beds[bedIndex]);
        }
        catch (error) {
    ...
    async release(id) {
        try {
            ...
            beds[bedIndex].updatedAt = new Date().toISOString();
            this.store.save(beds);
            return response_util_1.ResponseUtil.updated('Bed released successfully', beds[bedIndex]);
        }
        catch (error) {
    ...
    async updateStatus(id, status) {
        try {
            ...
            beds[bedIndex].updatedAt = new Date().toISOString();
            this.store.save(beds);
            return response_util_1.ResponseUtil.updated('Bed status updated successfully', beds[bedIndex]);
        }
        catch (error) {
