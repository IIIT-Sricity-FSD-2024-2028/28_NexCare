...
let BedsService = class BedsService {
    constructor() {
        this.beds = [
            { id: 'E1', ward: 'Emergency', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Ravi Kumar' },
            { id: 'E2', ward: 'Emergency', status: api_response_interface_1.BedStatus.CRITICAL, patient: 'Anita Sharma' },
            { id: 'E3', ward: 'Emergency', status: api_response_interface_1.BedStatus.AVAILABLE, patient: '' },
            { id: 'G1', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'John Doe' },
            { id: 'G2', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Priya Singh' },
            { id: 'G3', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Amit Verma' },
            { id: 'G4', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Kiran Rao' },
            { id: 'G5', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Rahul Jain' },
            { id: 'G6', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Deepak Kumar' },
            { id: 'G7', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Arjun Reddy' },
            { id: 'G8', ward: 'General', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Neha Gupta' },
            ...
            { id: 'P1', ward: 'Pediatrics', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Kid A' },
            ...
            { id: 'M1', ward: 'Maternity', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Mother A' },
            { id: 'M2', ward: 'Maternity', status: api_response_interface_1.BedStatus.OCCUPIED, patient: 'Mother B' },
