...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin@nexcare.com', description: 'User email address' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: api_response_interface_1.UserRole, example: api_response_interface_1.UserRole.SUPERUSER, description: 'Role to login as' }),
