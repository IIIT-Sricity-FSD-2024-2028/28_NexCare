...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'NexCare Hospital', description: 'New value for the setting' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Value is required' }),
    __metadata("design:type", String)
], UpdateSystemSettingsDto.prototype, "value", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Hospital name for display purposes', description: 'Updated description' }),
