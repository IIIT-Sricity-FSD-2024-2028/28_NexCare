...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User creation result (check success field)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User retrieved (check success field for not-found)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User update result (check success field)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User deletion result (check success field)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Status update result (check success field)' }),
    __param(0, (0, common_1.Param)('id')),
