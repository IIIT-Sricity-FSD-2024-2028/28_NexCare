...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: api_response_interface_1.UserRole, example: api_response_interface_1.UserRole.ADMINISTRATIVE_STAFF, description: 'User role' }),
    (0, class_validator_1.IsOptional)(),
